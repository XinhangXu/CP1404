...
for names_n in full_names:
    lowercase_full_names.append(names_n.lower())
...
numbers = []
for number_m in almost_numbers:
    almost_numbers.append(int(number_m))
print(numbers)

# TODO: use a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
numbers_g = []
for number_z in numbers:
    if number_z > 9:
        numbers_g.append(number_z)
print(numbers_g)